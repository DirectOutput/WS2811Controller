 ...
 .equ FT245_StatusPin=PINA
 .equ FT245_StatusPort=PORTA
 .equ FT245_StatusDDR=DDRA
...
Init:	
  ...
  ;Set led port bit to output & turn led off
  SetPortBit Led_DDR,Led_Bit
  ClearPortBit Led_Port,Led_Bit
